  ...
  return (
    <header className="pf-topbar">
      ...
      <nav className="pf-nav" aria-label="Navegação principal">
        <a href="#" className="pf-nav-link">
          <Home size={18} />
          Início
        </a>
        <a href="#" className="pf-nav-link pf-nav-link-active">
          <Briefcase size={18} />
          Projetos
        </a>
      </nav>
      ...
      <div className="pf-user-area">
        <button className="pf-icon-button" aria-label="Notificações">
          <Bell size={20} />
          <span>3</span>
        </button>
        <img className="pf-avatar" src="https://i.pravatar.cc/120?img=13" alt="Prof. Carlos" />
