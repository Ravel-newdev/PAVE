  ...
  return (
    <header className="po-topbar">
      <div className="po-brand">
        <img src={logo} alt="PAVE UFC" />
      </div>
      <nav className="po-nav" aria-label="Navegação principal">
        <a href="#" className="po-nav-link">
          <Home size={18} />
          Início
        </a>
        <a href="#" className="po-nav-link po-nav-link-active">
          <Briefcase size={18} />
          Projetos
        </a>
      </nav>
      <div className="po-user-area">
        <button className="po-icon-button" aria-label="Notificações">
          <Bell size={20} />
          <span>3</span>
        </button>
        <img className="po-avatar" src="https://i.pravatar.cc/120?img=13" alt="Prof. Carlos" />
        <strong>Prof. Carlos</strong>
      </div>
    </header>
  );
}
