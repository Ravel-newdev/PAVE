  ...
  return (
    <header className="kc-header">
      <div className="kc-logo-wrap">
        <img src={logo} alt="PAVE UFC" className="kc-logo" />
      </div>

      <nav className="kc-nav" aria-label="Navegação principal">
        <a href="#" className="kc-nav-link">
          <LayoutDashboard size={18} />
          Início
        </a>
        <a href="#" className="kc-nav-link active">
          <Briefcase size={18} />
          Projetos
        </a>
      </nav>

      <div className="kc-user-area">
        <button className="kc-bell" aria-label="Notificações" type="button">
          <Bell size={22} />
          <span>3</span>
        </button>
        <img
          className="kc-user-photo"
          src="https://i.pravatar.cc/120?img=15"
          alt="Foto do professor Carlos"
        />
