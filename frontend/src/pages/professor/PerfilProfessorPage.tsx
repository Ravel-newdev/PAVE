...
import { ArrowLeft, Mail, Phone, MapPin, Calendar, Lock, LogOut, Edit2 } from 'lucide-react'
    ...
    <div className="min-h-screen bg-[#F8FAFC] font-sans antialiased text-gray-800 flex flex-col justify-between">
      <div>
        <main className="max-w-4xl mx-auto px-6 py-10">
          <button type="button" onClick={() => navigate({ to: '/professor' })} className="inline-flex items-center gap-2 text-sm font-semibold text-[#2E7D32] hover:text-[#1B5E20] transition mb-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            ...
            <button type="button" onClick={() => navigate({ to: '/professor/perfil-editar' })} className="inline-flex items-center justify-center gap-2 border border-gray-200 text-gray-600 font-semibold h-11 px-5 rounded-xl text-sm bg-white hover:bg-gray-50 transition shadow-sm shrink-0 cursor-pointer">
              <Edit2 className="w-4 h-4 text-gray-400 pointer-events-none" />
              Editar perfil
            </button>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8 mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="flex flex-col gap-1.5">
                ...
                <div className="border border-gray-200/60 rounded-xl h-11 px-4 flex items-center text-sm font-semibold text-gray-700 bg-gray-50/50">{perfil.nome}</div>
              </div>
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-bold text-gray-400 uppercase tracking-wider">E-mail institucional</label>
                <div className="border border-gray-200/60 rounded-xl h-11 px-4 flex items-center text-sm font-semibold text-gray-700 bg-gray-50/50">{perfil.email}</div>
              </div>
              <div className="flex flex-col gap-1.5">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-gray-50/50 border border-gray-100 rounded-xl p-4">
              ...
              <button type="button" onClick={() => navigate({ to: '/professor/perfil-editar', hash: 'senha' })} className="w-full sm:w-auto inline-flex items-center justify-center gap-2 border border-gray-200 text-gray-600 text-xs font-bold px-4 h-10 rounded-xl bg-white hover:bg-gray-50 transition shadow-sm">
                <Lock className="w-3.5 h-3.5" />
                Alterar senha
              </button>
            </div>
            <div className="border-t border-gray-100 mt-8 pt-6 flex justify-end">
              <button type="button" onClick={logout} className="inline-flex items-center gap-2 text-sm text-red-500 hover:text-red-600 font-bold transition px-4 py-2 rounded-xl hover:bg-red-50/50">
