      ...
      <main className="max-w-6xl mx-auto px-8 py-8 flex-1 w-full space-y-6">
        ...
        >
          <div className="relative z-10">
            ...
            <h1 className="text-2xl font-bold text-[#1E2E4F]">
        ...
        <section className="bg-white rounded-2xl border border-[#E2E8F0] shadow-[0_4px_20px_rgba(0,0,0,0.03)] overflow-hidden">
          <div className="flex items-center justify-between px-6 py-4 border-b border-[#E2E8F0]">
            ...
            <a href="#" className="text-sm text-[#287999] font-semibold hover:underline flex items-center gap-1">
              Ver todos →
            </a>
          </div>
        ...
        <section className="bg-white rounded-2xl border border-[#E2E8F0] shadow-[0_4px_20px_rgba(0,0,0,0.03)] overflow-hidden">
          <div className="flex items-center justify-between px-6 py-4 border-b border-[#E2E8F0]">
            ...
            <a href="#" className="text-sm text-[#287999] font-semibold hover:underline">
              Ver todas →
            </a>
          </div>
